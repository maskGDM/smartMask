...
void SubmitHttpRequest()
{
  ...
  String webServices = "http://190.15.134.19:8080/SmartBox/RecordsS?pp=" + String(analogica_mq135internal) + "&m=" + String("520181") + "&a="+boolean(alertppm)+ "&t="+String(temperatura_bme280)+ "&p="+String(presion_bme280)+ "&al="+String(altitud_bme280)+ "&h="+String(humedad_bme280)+"";//concatenated string for submission
